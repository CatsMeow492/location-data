hobbies = ["Archery", "Bowling", "Canoeing", "Dance", "Embroirdery", "Flute", "Gymnastics"]
...
extras = ["Gym", "Cinema", "Restuarants", "Jewellery", "Coffee", "Netflix", "Bingo"]
...
savings = str(savings)
print("You'll save " + savings + " euros bby sticking to these extras:")
print(extras)
